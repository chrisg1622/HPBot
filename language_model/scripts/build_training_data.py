...
def main(base_directory):
    ...
    build_training_sequences = BuildTrainingSequences(base_directory=base_directory)
    ...
    flow.add_task(task=build_training_sequences)
    build_training_sequences.set_upstream(task=get_novel_sentence_tokens, flow=flow)
    build_training_sequences.bind(sentence_tokens=get_novel_sentence_tokens, flow=flow)
    flow.run()
